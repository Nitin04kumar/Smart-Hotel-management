...
export default function UserLoyaltyPage() {
    ...
    return (
      <div className="user-loyalty-page">
        <header>
          ...
          <p className="text-muted-foreground">Loading your loyalty information...</p>
        </header>
  ...
  if (!auth?.user) {
    return (
      <div className="user-loyalty-page">
        <header>
          <h1>Loyalty Points</h1>
          <p className="text-muted-foreground">Please log in to view your loyalty points.</p>
        </header>
        <div className="empty-state">
  ...
  return (
    <div className="user-loyalty-page">
      <header>
        <h1>Loyalty Points</h1>
        <p className="text-muted-foreground">Earn points on every booking and redeem for rewards.</p>
      </header>
      ...
      <div className="loyalty-overview">
        ...
        <div className="loyalty-points">
          <div className="points-value">{info?.available ?? info?.points ?? 0}</div>
      ...
      <div className="rewards-grid">
        <div className="reward-card">
          ...
          <p className="reward-description">Total points earned from all your bookings</p>
        </div>
        ...
        <div className="reward-card">
          ...
          <p className="reward-description">Points you've successfully redeemed</p>
        </div>
      </div>
        ...
        <div className="form-row">
          <div className="form-group">
            ...
            <input 
              ...
              required 
            />
            <small className="text-muted-foreground">Conversion: 100 points = ₹100</small>
          </div>
            ...
            {info.history.map((h) => (
              <div key={h.id} className="reward-card">
                <div className="reward-header">
                  ...
                  <div className={`reward-points ${h.type === 'earned' ? 'text-green-600' : 'text-red-600'}`}>
